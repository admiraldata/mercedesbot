...
class HelloWorld(Component):
    ...
    def start(self):
        ...
        text='Thank you. I will send a notification directly to your messenger when I have something exciting to share. Or, if you don’t want to receive our updates, you can message me with ‘unsubscribe’ anytime.'
